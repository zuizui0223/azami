...
def reconstruct_environment(core_environment: Path, out_dir: Path, raster_cache_dir: Path | None) -> Path:
    ...
    command: list[object] = [
        sys.executable,
        "legacy/v2/analysis/sample_chelsa_process_environment.py",
        "--environment",
        core_environment,
        "--source-contract",
...
def rebuild_full27(traits: Path, environment: Path, reference_environment: Path, out_dir: Path) -> None:
    ...
    run(
        sys.executable,
        "legacy/v2/analysis/run_geb_v2_full27_environment_atlas.py",
        "--contract",
    ...
    run(
        sys.executable,
        "legacy/v2/analysis/validate_geb_v2_full27_environment_atlas.py",
        "--contract",
        "legacy/ch1_global/v2/ontology/ch1_continuous_trait_contract.csv",
        "--traits-long",
        traits,
...
def rebuild_secondary(traits: Path, environment: Path, out_dir: Path) -> None:
    run(
        sys.executable,
        "legacy/v2/analysis/run_capitulum_functional_space.py",
        "--traits-long",
        traits,
        "--out-dir",
    ...
    run(
        sys.executable,
        "legacy/v2/analysis/run_capitulum_environment_blocks.py",
        "--traits-long",
        traits,
        "--environment",
        environment,
    ...
    run(
        sys.executable,
        "legacy/v2/analysis/run_capitulum_environment_incremental.py",
        "--traits-long",
        traits,
        "--environment",
        environment,
...
def rebuild_optional_sensitivities(
    ...
    if args.with_sampling:
        ...
        run(
            sys.executable,
            "legacy/v2/analysis/run_geb_v2_full27_sampling_composition_sensitivity.py",
            "--analysis-contract",
            "analysis/ch1/v2_full27_environment_atlas_contract.json",
    ...
    if args.with_spatial or args.with_historical:
        run(
            sys.executable,
            "legacy/v2/analysis/run_geb_v2_full27_spatial_sensitivity.py",
            "--analysis-contract",
            "analysis/ch1/v2_full27_environment_atlas_contract.json",
            "--traits-long",
            traits,
    ...
    if args.with_historical:
        ...
        run(
            sys.executable,
            "legacy/v2/analysis/run_geb_v2_full27_historical_sensitivity.py",
            "--analysis-contract",
            "analysis/ch1/v2_full27_environment_atlas_contract.json",
            "--traits-long",
            traits,
...
def main() -> int:
    ...
    run(
        sys.executable,
        "legacy/v2/analysis/audit_v2_environment_collinearity.py",
        "--environment",
        reference_environment,
        "--out-dir",
