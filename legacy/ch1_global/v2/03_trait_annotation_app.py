...
Install once
------------
python -m pip install -r legacy/ch1_global/v2/requirements_annotation_app.txt

Run
---
streamlit run legacy/ch1_global/v2/03_trait_annotation_app.py -- \
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit(
            ...
            "legacy/ch1_global/v2/requirements_annotation_app.txt"
        ) from error
