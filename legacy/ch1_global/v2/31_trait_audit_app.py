...
Local mode reads an on-disk public task packet and writes progress atomically::
    ...
    streamlit run legacy/ch1_global/v2/31_trait_audit_app.py -- \
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit(
            "Streamlit is required: python -m pip install -r legacy/ch1_global/v2/requirements_trait_audit_app.txt"
        ) from error
