...
python legacy/ch1_global/v2/06_download_inat_screening_queue.py \
...
python legacy/ch1_global/v2/07_screen_downloaded_images_with_yolo.py \
  --queue queue_shard.csv \
...
python legacy/ch1_global/v2/18_build_head_context_crops.py \
...
python legacy/ch1_global/v2/28_build_detected_head_trait_packet.py \
...
python legacy/ch1_global/v2/35_score_traits_ai_ensemble.py \
  ...
  --ontology legacy/ch1_global/v2/ontology/ch1_trait_ontology.csv \
  --prompt-spec legacy/ch1_global/v2/ontology/clip_trait_prompt_spec.json \
