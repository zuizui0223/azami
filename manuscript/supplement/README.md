...
- `SUPPLEMENTARY_INFORMATION.md` contains supplementary methods, figure captions and claim boundaries.
...
The withdrawn raw lability/quadrant result appears only as statistical provenance/QA. It is not a biological supplementary result. Independent detector and continuous-measurement validation remain external scientific gates and are not replaced by these figures.
