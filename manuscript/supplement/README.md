...
Figures S6–S7 are sampling/measurement diagnostics rather than additional biological tests. Figure S6 shows how geographic sampling density changes through the coordinate and positional-accuracy filters and taxon × 0.25° thinning. Figure S7 shows geographic variation in whether image-derived orientation, colour and outline are assessable; unassessable images remain measurement missingness and are never interpreted as biological trait absence.
