...
Full source provenance, artifact identifiers, interpretation boundaries and SHA-256 hashes are recorded in `FIGURE_MANIFEST.md`. References cited specifically in this Supporting Information are listed in `REFERENCES.md`. The withdrawn rho = -0.333 lability/quadrant graphic is not included.
