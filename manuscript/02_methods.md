...
Benjamini-Hochberg correction formed one global family across all successful unit by predictor rows separately for within taxa, among-taxon minimum-five and among-taxon minimum-two scopes. Historical endpoint tiers did not split multiplicity or remove rows. Each primary minimum-five row was classified as supported at both scales, within taxa only, among taxa only, neither, or not comparable (Figure 4; Tables S4–S6).
